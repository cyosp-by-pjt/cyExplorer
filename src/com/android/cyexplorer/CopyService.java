...
public class CopyService extends IntentService {
    ...
    private static final String EXTRA_CANCEL = "com.android.cyexplorer.CANCEL";
    public static final String EXTRA_SRC_LIST = "com.android.cyexplorer.SRC_LIST";
    public static final String EXTRA_STACK = "com.android.cyexplorer.STACK";
    public static final String EXTRA_FAILURE = "com.android.cyexplorer.FAILURE";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            mSrcClient = cyExplorerApplication.acquireUnstableProviderOrThrow(getContentResolver(),
                    srcs.get(0).authority);
            mDstClient = cyExplorerApplication.acquireUnstableProviderOrThrow(getContentResolver(),
            ...
            if (mFailedFiles.size() > 0) {
                ...
                final Intent navigateIntent = new Intent(context, cyExplorerActivity.class);
