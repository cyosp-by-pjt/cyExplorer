...
import static com.android.cyexplorer.BaseActivity.State.ACTION_BROWSE;
import static com.android.cyexplorer.BaseActivity.State.ACTION_BROWSE_ALL;
import static com.android.cyexplorer.BaseActivity.State.ACTION_CREATE;
import static com.android.cyexplorer.BaseActivity.State.ACTION_GET_CONTENT;
import static com.android.cyexplorer.BaseActivity.State.ACTION_MANAGE;
import static com.android.cyexplorer.BaseActivity.State.ACTION_OPEN;
import static com.android.cyexplorer.BaseActivity.State.ACTION_OPEN_TREE;
import static com.android.cyexplorer.BaseActivity.State.MODE_GRID;
import static com.android.cyexplorer.BaseActivity.State.MODE_LIST;
import static com.android.cyexplorer.BaseActivity.State.MODE_UNKNOWN;
import static com.android.cyexplorer.BaseActivity.State.SORT_ORDER_UNKNOWN;
import static com.android.cyexplorer.cyExplorerActivity.TAG;
import static com.android.cyexplorer.model.DocumentInfo.getCursorInt;
import static com.android.cyexplorer.model.DocumentInfo.getCursorLong;
import static com.android.cyexplorer.model.DocumentInfo.getCursorString;
...
import com.android.cyexplorer.BaseActivity.State;
import com.android.cyexplorer.ProviderExecutor.Preemptable;
import com.android.cyexplorer.RecentsProvider.StateColumns;
import com.android.cyexplorer.model.DocumentInfo;
import com.android.cyexplorer.model.DocumentStack;
import com.android.cyexplorer.model.RootInfo;
...
public class DirectoryFragment extends Fragment {
    ...
    private cyExplorerAdapter mAdapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new cyExplorerAdapter();
        ...
        mCallbacks = new LoaderCallbacks<DirectoryResult>() {
            ...
            public Loader<DirectoryResult> onCreateLoader(int id, Bundle args) {
                ...
                switch (mType) {
                    ...
                    case TYPE_RECENT_OPEN:
                        final RootsCache roots = cyExplorerApplication.getRootsCache(context);
            ...
            public void onLoadFinished(Loader<DirectoryResult> loader, DirectoryResult result) {
                ...
                if (mType == TYPE_RECENT_OPEN && mAdapter.isEmpty() && !state.stackTouched &&
                        context instanceof cyExplorerActivity) {
                    ((cyExplorerActivity) context).setRootsDrawerOpen(true);
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        CopyService.start(getActivity(), getDisplayState(this).selectedcyExplorerForCopy,
    ...
    private MultiChoiceModeListener mMultiListener = new MultiChoiceModeListener() {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            if (id == R.id.menu_open) {
                BaseActivity.get(DirectoryFragment.this).oncyExplorerPicked(docs);
                mode.finish();
                return true;

            } else if (id == R.id.menu_share) {
                onSharecyExplorer(docs);
                mode.finish();
                return true;

            } else if (id == R.id.menu_delete) {
                onDeletecyExplorer(docs);
                mode.finish();
                return true;

            } else if (id == R.id.menu_copy) {
                onCopycyExplorer(docs);
                mode.finish();
                return true;
    ...
    private void onSharecyExplorer(List<DocumentInfo> docs) {
        Intent intent;
    ...
    private void onDeletecyExplorer(List<DocumentInfo> docs) {
        final Context context = getActivity();
        ...
        for (DocumentInfo doc : docs) {
            ...
            try {
                client = cyExplorerApplication.acquireUnstableProviderOrThrow(
    ...
    private void onCopycyExplorer(List<DocumentInfo> docs) {
        getDisplayState(this).selectedcyExplorerForCopy = docs;

        // Pop up a dialog to pick a destination.  This is inadequate but works for now.
        // TODO: Implement a picker that is to spec.
        final Intent intent = new Intent(
                BaseActivity.cyExplorerIntent.ACTION_OPEN_COPY_DESTINATION,
                Uri.EMPTY,
                getActivity(),
                cyExplorerActivity.class);
        ...
        intent.putExtra(BaseActivity.cyExplorerIntent.EXTRA_DIRECTORY_COPY, directoryCopy);
    ...
    private class cyExplorerAdapter extends BaseAdapter {
        ...
        private View getDocumentView(int position, View convertView, ViewGroup parent) {
            ...
            final RootsCache roots = cyExplorerApplication.getRootsCache(context);
            final ThumbnailCache thumbs = cyExplorerApplication.getThumbnailsCache(
                    context, mThumbSize);
