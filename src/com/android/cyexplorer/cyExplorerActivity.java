...
import static com.android.cyexplorer.BaseActivity.State.ACTION_OPEN_COPY_DESTINATION;
import static com.android.cyexplorer.BaseActivity.State.ACTION_OPEN_TREE;
import static com.android.cyexplorer.DirectoryFragment.ANIM_DOWN;
import static com.android.cyexplorer.DirectoryFragment.ANIM_NONE;
import static com.android.cyexplorer.DirectoryFragment.ANIM_UP;
...
import com.android.cyexplorer.RecentsProvider.RecentColumns;
import com.android.cyexplorer.RecentsProvider.ResumeColumns;
import com.android.cyexplorer.model.DocumentInfo;
import com.android.cyexplorer.model.DocumentStack;
import com.android.cyexplorer.model.DurableUtils;
import com.android.cyexplorer.model.RootInfo;

public class cyExplorerActivity extends BaseActivity {
    private static final int CODE_FORWARD = 42;
    public static final String TAG = "cyExplorer";
    ...
    private State buildDefaultState() {
        ...
        // } else if (cyExplorerIntent.ACTION_OPEN_COPY_DESTINATION.equals(action)) {
        ...
        if (state.action == ACTION_OPEN_COPY_DESTINATION) {
            state.directoryCopy = intent.getBooleanExtra(
                    BaseActivity.cyExplorerIntent.EXTRA_DIRECTORY_COPY, false);
        }
    ...
    @Override
    public void oncyExplorerPicked(List<DocumentInfo> docs) {
    ...
    public static cyExplorerActivity get(Fragment fragment) {
        return (cyExplorerActivity) fragment.getActivity();
    }
    ...
    final class CreateFinishTask extends AsyncTask<Void, Void, Uri> {
        ...
        protected void onPostExecute(Uri result) {
            if (result != null) {
                ...
                Toast.makeText(cyExplorerActivity.this, R.string.save_error, Toast.LENGTH_SHORT)
                        .show();
            }
