...
/**
 * ToolBar of cyExplorer UI.
 */
public class cyExplorerToolBar extends Toolbar {
    ...
    public cyExplorerToolBar(Context context, AttributeSet attrs,
    ...
    public cyExplorerToolBar(Context context) {
        super(context);
    }
