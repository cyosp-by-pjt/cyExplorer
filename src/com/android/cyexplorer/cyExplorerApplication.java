...
public class cyExplorerApplication extends Application {
    ...
    public static RootsCache getRootsCache(Context context) {
        return ((cyExplorerApplication) context.getApplicationContext()).mRoots;
    }

    public static ThumbnailCache getThumbnailsCache(Context context, Point size) {
        final cyExplorerApplication app = (cyExplorerApplication) context.getApplicationContext();
