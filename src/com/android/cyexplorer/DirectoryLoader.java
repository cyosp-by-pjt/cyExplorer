...
import static com.android.cyexplorer.BaseActivity.State.SORT_ORDER_DISPLAY_NAME;
import static com.android.cyexplorer.BaseActivity.State.SORT_ORDER_LAST_MODIFIED;
import static com.android.cyexplorer.BaseActivity.State.SORT_ORDER_SIZE;
...
public class DirectoryLoader extends AsyncTaskLoader<DirectoryResult> {
    ...
    public final DirectoryResult loadInBackground() {
        ...
        try {
            client = cyExplorerApplication.acquireUnstableProviderOrThrow(resolver, authority);
